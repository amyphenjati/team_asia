...
def start(update: Update, _: CallbackContext) -> None:
    ...
    update.message.reply_text(
        f"Hello, I am your personal consultant. Your mental health is very important, so let check in on how you are doing! We will now be asking you 10 yes/no questions. Type /poll to continue or /help to learn more."
    )
...
def help_handler(update: Update, _: CallbackContext) -> None:
    """You've answered 3 or more "yes" to these questions. If you have felt this way most every day for several weeks,
    you may be experiencing depression and should seek a full assessment by a psychiatrist, mental health counselor or other health care professional.
